...
// writer.write("Cliente aceptado");
				...
				String pregunta;
				try (BufferedReader LPreguntas = new BufferedReader(new FileReader("Data\\Preguntas.txt"))) {
	...
	private String obtenerRespuesta(int numeroPregunta) {
		try (BufferedReader br = new BufferedReader(new FileReader("Data\\Respuestas.txt"))) {
			String linea;
